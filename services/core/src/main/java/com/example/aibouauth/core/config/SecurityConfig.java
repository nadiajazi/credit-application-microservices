...
import static com.example.aibouauth.core.user.Permission.*;
import static com.example.aibouauth.core.user.Role.ADMIN;
import static com.example.aibouauth.core.user.Role.MANAGER;
